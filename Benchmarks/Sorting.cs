...
// |---------- |------------ |---------------:|-------------:|-------------:|---------------:|-----:|----------:|
// |     Radix |           8 |     2,646.8 ns |     56.46 ns |    144.72 ns |     2,600.0 ns |    4 |    1312 B |
// | ArraySort |           8 |       375.0 ns |     24.12 ns |     69.59 ns |       350.0 ns |    1 |     640 B |
// |  LinqSort |           8 |     1,958.5 ns |     41.08 ns |     74.08 ns |     2,000.0 ns |    3 |    1040 B |
// |     Radix |          64 |     3,444.0 ns |     68.65 ns |     91.65 ns |     3,400.0 ns |    5 |    1312 B |
// | ArraySort |          64 |     1,472.6 ns |     31.30 ns |     84.10 ns |     1,500.0 ns |    2 |     640 B |
// |  LinqSort |          64 |     5,728.6 ns |    112.18 ns |     99.45 ns |     5,750.0 ns |    6 |    1936 B |
// |     Radix |         512 |     8,292.9 ns |    168.28 ns |    149.17 ns |     8,250.0 ns |    7 |    1312 B |
// | ArraySort |         512 |    13,820.0 ns |    265.58 ns |    248.42 ns |    13,900.0 ns |    8 |     640 B |
// |  LinqSort |         512 |    46,523.1 ns |    285.72 ns |    238.59 ns |    46,500.0 ns |   10 |    9104 B |
// |     Radix |        2048 |    25,592.3 ns |    192.24 ns |    160.53 ns |    25,500.0 ns |    9 |    1312 B |
// | ArraySort |        2048 |    66,316.7 ns |  1,279.47 ns |  1,196.82 ns |    65,850.0 ns |   11 |     640 B |
// |  LinqSort |        2048 |   223,864.3 ns |  1,189.40 ns |  1,054.37 ns |   223,950.0 ns |   12 |   33680 B |
// |     Radix |       32768 |   504,620.0 ns |  2,015.97 ns |  1,885.74 ns |   505,100.0 ns |   13 |    1312 B |
// | ArraySort |       32768 | 1,384,642.9 ns |  2,629.02 ns |  2,330.55 ns | 1,384,850.0 ns |   15 |     640 B |
// |  LinqSort |       32768 | 5,037,606.7 ns | 25,937.15 ns | 24,261.62 ns | 5,030,900.0 ns |   17 |  525200 B |
// |     Radix |       65536 | 1,102,678.6 ns |  5,964.59 ns |  5,287.46 ns | 1,100,150.0 ns |   14 |    1312 B |
// | ArraySort |       65536 | 2,969,253.3 ns |  7,139.40 ns |  6,678.20 ns | 2,968,300.0 ns |   16 |     640 B |
// |  LinqSort |       65536 | 8,788,761.3 ns | 61,962.58 ns | 94,623.40 ns | 8,791,200.0 ns |   18 | 1049488 B |