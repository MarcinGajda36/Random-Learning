...
public static class TestGeneric
{
        ...
        // where TDelegate : Map<int, string>
    {
        ...
        var func1 = static int (in int x) => x;
        TestDelegate(func1);
        //var mapped = @delegate.Map<int, string>(i => "");
    }
    public static string TestMap(int i) => i.ToString();
    public static void TestTestDelegate() => TestDelegate(new Func<int>(() => 2));
